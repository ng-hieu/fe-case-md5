            ...
            <div id="top-banner-1" className="banner">
              <div className="banner-inner-wrapper header-text">
                <div className="main-caption">
                  <h2>As comfortable as your home:</h2>
                  <h1>Ba Dinh</h1>
                </div>
                      ...
                      <div className="more-info">
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-6">
                            ...
                            <h4><span>Territory:</span><br />50 M2</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-home" />
                            <h4><span>AVG Price:</span><br />946.000 VND</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                    ...
                    <div className="col-lg-12">
                      <div className="more-info">
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-globe" />
                            <h4><span>Territory:</span><br />65 M2</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-home" />
                            <h4><span>AVG Price:</span><br />1.100.000 VND</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <div className="main-button">
                              <a href="about.html">Explore More</a>
                    ...
                    <div className="col-lg-12">
                      <div className="more-info">
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-globe" />
                            <h4><span>Territory:</span><br />40 M2</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-home" />
                            <h4><span>AVG Price:</span><br />800.000 VND</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <div className="main-button">
                              <a href="about.html">Explore More</a>
                    ...
                    <div className="col-lg-12">
                      <div className="more-info">
                        <div className="row">
                          ...
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-globe" />
                            <h4><span>Territory:</span><br />70 M2</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <i className="fa fa-home" />
                            <h4><span>AVG Price:</span><br />1.200.000 VND</h4>
                          </div>
                          <div className="col-lg-3 col-sm-6 col-6">
                            <div className="main-button">
                              <a href="about.html">Explore More</a>
